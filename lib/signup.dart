...
class _SignUpState extends State<SignUp> {
  ...
  final skype = TextEditingController();
  ...
  Widget build(BuildContext context) {
    mobileNumber = TextEditingController(text: widget.userMobileNumber);
    return MaterialApp(
                            ...
                            ClipOval(
                              child: Container(
                                  ...
                                  child: _image != null
                                      ...
                                      : Container()
                                  // Empty container when no image is selected
                                  ),
                            ),
                            IconButton(
                              padding:
                                  const EdgeInsets.only(left: 90, top: 130),
                      ...
                      GestureDetector(
                        onTap: () async {
                          if (mobileNumber.text.isNotEmpty) {
                            ...
                            final result =
                                await ApiService().registerAndUpdateProfile(
