...
class ContactAdmin extends StatefulWidget {
  ...
  ContactAdmin({Key? key, required this.chatRoomId, required this.receiverId})
      : super(key: key);
  @override
...
class _ContactAdminState extends State<ContactAdmin> {
  final GlobalKey<_ContactAdminState> chatPageKey =
      GlobalKey<_ContactAdminState>();
  ...
  Future<void> _fetchOtherUserData() async {
    try {
      final result = await ApiService().getUserById('658c582ff1bc8978d2300823');
